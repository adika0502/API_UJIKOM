...
Route::middleware(['auth', 'role.admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/pengembalian/pilih', [AdminController::class, 'selectPengembalian'])->name('pengembalian.pilih');
...
// Halaman utama: redirect sesuai role jika sudah login, atau ke halaman login
Route::get('/', function () {
    if (auth()->check()) {
        $user = auth()->user();
