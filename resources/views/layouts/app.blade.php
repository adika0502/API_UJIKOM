        ...
        <aside class="w-64 bg-ink text-[#EDEAE0] flex-col hidden md:flex border-r border-line">
            ...
            <div class="p-6 border-b border-white/[0.06]">
                <div class="flex items-center gap-2.5">
                    <div class="w-9 h-9 rounded-lg bg-surface2 border border-line flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        <p class="text-sm font-semibold tracking-wide leading-tight">
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                ...
                @if(auth()->user()->role === 'admin')
                    <p class="px-3 text-[11px] font-mono text-[#5C6472] mb-2">Menu utama</p>

                    <a href="{{ route('admin.dashboard') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.dashboard') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                        @if(request()->routeIs('admin.dashboard'))
                            <span class="absolute left-0 top-1.5 bottom-1.5 w-[3px] bg-amber rounded-r"></span>
                        @endif
                    ...
                    <a href="{{ route('admin.alat.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.alat*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.kategori.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.kategori*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <p class="px-3 text-[11px] font-mono text-[#5C6472] mb-2 mt-5">Transaksi</p>

                    <a href="{{ route('admin.peminjaman.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.peminjaman*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.pengembalian.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.pengembalian*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <p class="px-3 text-[11px] font-mono text-[#5C6472] mb-2 mt-5">Lainnya</p>

                    <a href="{{ route('admin.log.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.log*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.user.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('admin.user*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                ...
                @elseif(auth()->user()->role === 'petugas')
                    ...
                    <a href="{{ route('petugas.peminjaman.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('petugas.peminjaman*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <a href="{{ route('petugas.pengembalian.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('petugas.pengembalian*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <a href="{{ route('petugas.laporan.index') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('petugas.laporan*') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                ...
                @elseif(auth()->user()->role === 'peminjam')
                    ...
                    <a href="{{ route('peminjam.katalog') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('peminjam.katalog') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
                    ...
                    <a href="{{ route('peminjam.riwayat') }}"
                        class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition relative
                        {{ request()->routeIs('peminjam.riwayat') ? 'bg-surface2 text-white' : 'text-[#9AA2AF] hover:bg-surface hover:text-white' }}">
            ...
            <div class="p-4 border-t border-white/[0.06] space-y-3">
                <div class="flex items-center gap-3 px-1">
                    <div class="w-9 h-9 rounded-full bg-amber-soft text-amber flex items-center justify-center font-mono font-semibold text-sm flex-shrink-0 border border-amber/30">
